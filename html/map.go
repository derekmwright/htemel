...
func (e *MapElement) If(cond bool, child htemel.Node) *MapElement {
	if cond {
...
func (e *MapElement) IfElse(cond bool, then, els htemel.Node) *MapElement {
	if cond {
		e.Children(then)
	} else {
		e.Children(els)
...
func (e *MapElement) IfThen(cond bool, fn func(*MapElement)) *MapElement {
	if cond {
		fn(e)
	}
	return e
