...
func (e *TfootElement) If(cond bool, child htemel.Node) *TfootElement {
	if cond {
...
func (e *TfootElement) IfElse(cond bool, then, els htemel.Node) *TfootElement {
	if cond {
		e.Children(then)
	} else {
		e.Children(els)
...
func (e *TfootElement) IfThen(cond bool, fn func(*TfootElement)) *TfootElement {
	if cond {
		fn(e)
	}
	return e
