...
func (e *PreElement) If(cond bool, child htemel.Node) *PreElement {
	if cond {
...
func (e *PreElement) IfElse(cond bool, then, els htemel.Node) *PreElement {
	if cond {
		e.Children(then)
	} else {
		e.Children(els)
...
func (e *PreElement) IfThen(cond bool, fn func(*PreElement)) *PreElement {
	if cond {
		fn(e)
	}
	return e
